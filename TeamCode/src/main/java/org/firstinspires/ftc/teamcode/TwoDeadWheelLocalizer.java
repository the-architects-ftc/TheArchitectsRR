...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -251.4869795315371; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 207.83266367880415; // x position of the perpendicular encoder (in tick units)
    }
